...
const CONFIG_DEFAULTS = [
  ...
  { key: 'company_logo_url', value: '', type: 'string', description: 'Public image URL for the logo in generated templates. Blank uses the text wordmark. Must load without a login — mail clients fetch it anonymously.' },
];

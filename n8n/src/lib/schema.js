 ...
 * column order, and the stage machine — the bootstrap script, the n8n
 * workflows, and the dashboard all read it, so a column can only be renamed in
 * one place.
 *
...
const TABS = {
  ...
  Templates: [
    ...
    'source', 'is_active', 'is_default', 'prompt_version', 'created_at', 'updated_at',
  ],
  JobRoles: [
...
const CONFIG_DEFAULTS = [
  ...
  { key: 'toggle_intake', value: 'true', type: 'boolean', description: 'Master switch for WF-01 Intake.' },
  { key: 'toggle_draft', value: 'true', type: 'boolean', description: 'Master switch for WF-02 Draft generation.' },
  { key: 'toggle_send', value: 'false', type: 'boolean', description: 'Master switch for WF-03 Send. Off by default — turn on deliberately.' },
  { key: 'toggle_replies', value: 'true', type: 'boolean', description: 'Master switch for WF-04 Reply watcher.' },
  { key: 'toggle_followup', value: 'false', type: 'boolean', description: 'Master switch for WF-05 Follow-up drafting.' },
  ...
  { key: 'company_name', value: 'Your Company', type: 'string', description: 'Merge field {{company_name}}.' },
